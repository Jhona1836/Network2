...
import com.example.network.Adaptadores.AdaptadorCategoria
...
import com.example.network.databinding.FragmentInicioBinding
...
class FragmentInicio : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        locacionSP = mContext.getSharedPreferences("LOCACION_SP", android.content.Context.MODE_PRIVATE)
