...
import com.example.network.CambiarPassword
import com.example.network.Login_email
import com.example.network.R
import com.example.network.RecuperarPassword
import com.example.network.constantes
import com.example.network.databinding.FragmentPerfilBinding
import com.example.network.editar_perfil
...
class FragmentPerfil : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.BtnEditarPerfil.setOnClickListener {
            startActivity(Intent(mContext, editar_perfil::class.java))
        }
