package com.example.network.Anuncios
...
import com.example.network.SeleccionarUbicacion
import com.example.network.constantes
import com.example.network.databinding.ActivityCrearAnuncioBinding
...
class crearAnuncio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.Ubicacion.setOnDismissListener {
        ...
        ref.child(idAnuncioEditar)
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.Ubicacion.setText(locacion)
    ...
    private fun validarDatos() {
        ...
        descripcion = binding.EtDescripcion.text.toString().trim()
         ...
         if (categoria.isEmpty()){
            ...
            binding.Ubicacion.error = "Ingrese una locación"
